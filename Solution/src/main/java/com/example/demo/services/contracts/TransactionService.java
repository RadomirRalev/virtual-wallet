...
public interface TransactionService {
    ...
    List<Transaction> getFilteredTransactions(String direction, String startDate, String endDate, String recipientSearchString, int userId, int page, String sort);

    List<Transaction> getFilteredTransactionsAdmin(String direction, String startDate, String endDate,String senderSearchString, String recipientSearchString, int userId, int page, String sort);
}
