...
public class ExceptionConstants {
    ...
    public static final String CREDIT_CARD_EXISTS = "This credit card %s already registered.";
    public static final String CREDIT_CARD_NOT_EXISTS = "Credit card with number %s not exist.";
    public static final String DEBIT_CARD_EXISTS = "This debit card %s already registered.";
